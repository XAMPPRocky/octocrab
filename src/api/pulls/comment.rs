...
pub struct ListCommentsBuilder<'octo, 'b> {
    ...
    sort: Option<crate::params::pulls::comment::Sort>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl<'octo, 'b> ListCommentsBuilder<'octo, 'b> {
    ...
    pub fn sort(mut self, sort: impl Into<crate::params::pulls::comment::Sort>) -> Self {
...
mod tests {
    ...
    async fn serialize() {
        ...
        let list = handler
            .list_comments(1)
            .sort(crate::params::pulls::comment::Sort::Updated)
